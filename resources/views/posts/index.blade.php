            ...
            <div class="absolute bottom-4 right-4">
                <button class="p-2 focus:outline-none hover:bg-gray-200 transition-colors">
                    <svg class="w-8 h-8 text-gray-400 fill-current hover:text-red-500" viewBox="0 0 24 24">
                        <!-- Alert icon SVG here... -->
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M12 5.177l8.631 15.823h-17.262l8.631-15.823zm0-4.177l-12 22h24l-12-22zm-1 9h2v6h-2v-6zm1 9.75c-.689 0-1.25-.56-1.25-1.25s.561-1.25 1.25-1.25 1.25.56 1.25 1.25-.561 1.25-1.25 1.25z"/></svg>                    </svg>
                </button>
            </div>
        </div>
    @endforeach
